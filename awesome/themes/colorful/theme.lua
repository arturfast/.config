...
-- {{{ Main
local theme = {}
theme.wallpaper = "/home/artur/.config/awesome/themes/colorful/colourful_wallpaper.jpg"
-- }}}
...
theme.bg_normal  = "#DCDCCC00"
theme.bg_focus   = "#1E2320"
theme.bg_urgent  = "#3F3F3F"
theme.bg_systray = theme.bg_normal
theme.wibar_bg   = "#3F3F3F00"
-- }}}
...
--+
theme.prompt_bg_cursor = "#2000000"

--#
theme.tasklist_bg_normal = "#2000000"
theme.tasklist_bg_focus = "#2000000"
...
-- {{{ Misc
theme.awesome_icon           = themes_path .. "custom/icon.png"
theme.menu_submenu_icon      = themes_path .. "default/submenu.png"
-- }}}

-- {{{ Layout
theme.layout_tile       = themes_path .. "colorful/layouts/tile.png"
theme.layout_tileleft   = themes_path .. "colorful/layouts/tileleft.png"
theme.layout_tilebottom = themes_path .. "colorful/layouts/tilebottom.png"
theme.layout_tiletop    = themes_path .. "colorful/layouts/tiletop.png"
theme.layout_fairv      = themes_path .. "colorful/layouts/fairv.png"
theme.layout_fairh      = themes_path .. "colorful/layouts/fairh.png"
theme.layout_spiral     = themes_path .. "colorful/layouts/spiral.png"
theme.layout_dwindle    = themes_path .. "colorful/layouts/dwindle.png"
theme.layout_max        = themes_path .. "colorful/layouts/max.png"
theme.layout_fullscreen = themes_path .. "colorful/layouts/fullscreen.png"
theme.layout_magnifier  = themes_path .. "colorful/layouts/magnifier.png"
theme.layout_floating   = themes_path .. "colorful/layouts/floating.png"
theme.layout_cornernw   = themes_path .. "colorful/layouts/cornernw.png"
theme.layout_cornerne   = themes_path .. "colorful/layouts/cornerne.png"
theme.layout_cornersw   = themes_path .. "colorful/layouts/cornersw.png"
theme.layout_cornerse   = themes_path .. "colorful/layouts/cornerse.png"
-- }}}
