...
local themes_path = string.format("/home/artur/.config/awesome/themes/amarena/theme.lua")
local layout_icon_path = string.format("/home/artur/.config/awesome/themes/amarena/theme.lua")
--# local titlebar_icon_path = string.format("/home/artur/.config/awesome/themes/amarena/layouts") 
--# local taglist_icon_path = string.format("/home/artur/.config/awesome/themes/amarena/theme.lua")
